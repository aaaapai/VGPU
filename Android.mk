...
LOCAL_CFLAGS += -g -O3 -Wno-pointer-sign -Wno-macro-redefined -Wno-dangling-else -Wno-pointer-sign -Wno-implicit-const-int-float-conversion -include include/android_debug.h
...
LOCAL_LDLIBS := -ldl -llog -L$(LOCAL_PATH)/libs/arm-v8a -lglslang -lspirv-cross-c-shared -l:c++.a
